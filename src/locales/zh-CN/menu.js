export default {
  ...
  "menu.order.percentage": "提成订单",
  "menu.billmanager": "发票管理",
  ...
  "menu.base.coupon": "优惠券",
  "menu.base.cartype": "车辆分类",
  "menu.base.carsit": "座位分类",
  "menu.base.carlevel": "用车服务",
  "menu.base.carmanager": "车辆管理",
  "menu.base.dispatchstrategy": "派单策略",
  "menu.base.address": "常用地址",
  "menu.base.driver": "司机评价",
  "menu.base.product": "产品评价",
  "menu.settlement": "结算管理",
  "menu.refund": "退款管理",
  "menu.discovery": "发现管理",
  "menu.discovery.discoveryapprove": "投稿管理",
  "menu.discovery.commentapprove": '评论管理',
